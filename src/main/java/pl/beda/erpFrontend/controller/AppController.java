...
import pl.beda.erpFrontend.App;
...
public class AppController implements Initializable {
    ...
    private final static String EMPLOYEE_MODULE_VIEW = "/pl/beda/erpFrontend/fxml/employee.fxml";
    private final static String WAREHOUSE_MODULE_VIEW = "/pl/beda/erpFrontend/fxml/warehouse.fxml";
    private final static String LOGIN_VIEW = "/pl/beda/erpFrontend/fxml/login.fxml";
